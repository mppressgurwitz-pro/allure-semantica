 ...
 *
 * Получаем единую таблицу с ранжированием для нашего SKU и для каждого конкурента.
 * Помогает быстро решать, какие запросы вытаскивать в текст карточки.
 * ============================================================================
 */
...
function computeScoring_(cleanedKeywords, log) {
  ...
  // 1. Найдём максимальную freq, чтобы нормализовать
  let maxFreq = 0;
