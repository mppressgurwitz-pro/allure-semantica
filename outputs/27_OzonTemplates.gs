...
var OZON_TEMPLATES = {
  ...
  OZON_CATEGORY_TO_FILENAME_PREFIX: {
    ...
    // LEGACY: только для обратной совместимости — может быть в _Config старых копий до 2026-05-31.
    // В WB_TO_OZON канон: «Косметика для ухода за волосами».
  ...
  WB_TO_OZON: {
    'Шампуни': 'Косметика для ухода за волосами',
    'Кондиционеры для волос': 'Косметика для ухода за волосами',
    ...
    // TODO 2026-05-31: добавить, когда у Маши появится первый SKU свечи/после бритья.
    // Нужно: уточнить subjectName в кабинете WB → положить как ключ. Возможные кандидаты:
    //   'Свечи декоративные' или 'Свечи ароматические' → 'Свеча'
    //   'Средства после бритья' → 'Средство после бритья'
    // До тех пор resolveOzonTemplateForWbCategory_ для этих subjectName упадёт в Ui.prompt
    // — это запланированное поведение, не баг.
  }
};
